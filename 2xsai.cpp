...
#ifdef MMX
extern "C" void _2xSaILine  (u8 *srcPtr, u8 *deltaPtr, u32 srcPitch, u32 width,
                        u8 *dstPtr, u32 dstPitch);
extern "C" void _2xSaISuperEagleLine  (u8 *srcPtr, u8 *deltaPtr, u32 srcPitch, u32 width,
                        u8 *dstPtr, u32 dstPitch);
extern "C" int Init_2xSaIMMX (u32 BitFormat);
#endif
...
namespace
{
    inline int GetResult1(u32 A, u32 B, u32 C, u32 D, u32 E)
    {
        int x = 0; 
        int y = 0;
        int r = 0;
    ...
    inline int GetResult2(u32 A, u32 B, u32 C, u32 D, u32 E) 
    {
        int x = 0; 
        int y = 0;
        int r = 0;
	     ...
	     u8 *dstPtr, u32 dstPitch, int width, int height)
{
	...
	for (height; height; height-=1)
	{
        	...
        	xP = (u16 *) deltaPtr;
	    	dP = (u32 *) dstPtr;
        	_2xSaISuperEagleLine  ((u8 *) bP, (u8 *) xP, srcPitch, width, (u8 *) dP, dstPitch);
		dstPtr += dstPitch << 1;
	    	srcPtr += srcPitch;
        	deltaPtr += srcPitch;
        }
	...
	for (height; height; height-=1)
	{
	    bP = (u16 *) srcPtr;
	    dP = (u32 *) dstPtr;
            for (u32 finish = width; finish; finish -= 1 )
            {
	     ...
	     u8 *dstPtr, u32 dstPitch, int width, int height)
{
	...
	for (height; height; height-=1)
	{
	    ...
	    xP = (u16 *) deltaPtr;
	    dP = (u32 *) dstPtr;
            _2xSaILine  ((u8 *) bP, (u8 *) xP, srcPitch, width, (u8 *)dP, dstPitch);
	    dstPtr += dstPitch << 1;
	    srcPtr += srcPitch;
            deltaPtr += srcPitch;
        }
